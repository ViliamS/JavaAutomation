...
//        wsc. = this;
        wsc.Connect("wss://dv2pub.opoqodev.com/pull/8114a4af-1b81-4698-8298-183edc1023c8");
        Thread.sleep(1000);
//        wsc.userSession
        wsc.Disconnect();
    }
...
//        Thread.sleep(1000);
        ...
        System.out.println("channeluuid: " + channeluuid);
...
//        httpPostIssueToken.setHeader("channeluuid", "8114a4af-1b81-4698-8298-183edc1023c8");
        httpPostIssueToken.setHeader("channeluuid", channeluuid);
