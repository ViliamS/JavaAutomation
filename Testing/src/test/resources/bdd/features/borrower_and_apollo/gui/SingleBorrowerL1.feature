...
#    PERSONAL DETAILS
    ...
    And Borrower types his firstname : Tonda
...
#    EMPLOYMENT & INCOME
    ...
    And Borrower selects the employment & income category : Paye
...
#    And Borrower checks the PAYE currently
    ...
    Then Borrower selects the employment & income category : Self Employed
    ...
    When Borrower clicks "ADD EMPLOYMENT"
#    Then Borrower selects the employment & income category : Unemployed/Homemaker
    Then Borrower selects the employment & income category : Unemployed
...
#    When Borrower clicks "ADD EMPLOYMENT"
#    Then Borrower selects the employment & income category : Other
...
#    And Borrower clicks "Add This Employment"
    ...
    And Coapplicant selects the employment & income category : Paye
    # problem of xpath or select method
...
#    And Coapplicant checks the PAYE currently
    ...
    Then Coapplicant selects the employment & income category : Self Employed
    ...
    When Coapplicant clicks "ADD EMPLOYMENT"
#    Then Coapplicant selects the employment & income category : Unemployed/Homemaker
    Then Coapplicant selects the employment & income category : Unemployed
...
#    When Coapplicant clicks "ADD EMPLOYMENT"
#    Then Coapplicant selects the employment & income category : Other
...
#    YOUR ACCOUNTS
    ...
    And Borrower types his Current IBAN: 1234
    ...
    And Borrower types his Savings IBAN: 1234
...
#    YOUR DEPENDANT
    ...
    When Borrower clicks "Depandants"
    Then Borrower has depandants
    ...
    And Borrower types the Dependant date of birth: 20/10/1975
    And Borrower clicks "ADD THIS DEPENDANT"
    And Borrower clicks Depandants "NEXT"
...
#    Then Borrower has properties
    ...
    And Borrower and Coapplicant upload the file file.txt as Current account - 1234 document
    And Borrower and Coapplicant upload the file file.txt as Credit card - provider document
    And Borrower uploads all documents

    And Borrower is on Apollo homepage
    When Borrower searches the created client on simple search
    And Borrower chooses 1st client
    And Borrower chooses 2nd client
    Then Borrower checks client's data
