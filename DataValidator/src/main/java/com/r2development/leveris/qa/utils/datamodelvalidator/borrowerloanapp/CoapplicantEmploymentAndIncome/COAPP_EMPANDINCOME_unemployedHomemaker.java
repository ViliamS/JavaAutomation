...
public enum COAPP_EMPANDINCOME_unemployedHomemaker implements IBWInterface, IBWSheetInterface {
    ...
    private static final Log log = LogFactory.getLog(COAPP_EMPANDINCOME_unemployedHomemaker.class.getName());

    private String getFieldName;
    private String getFieldNameValue;

    COAPP_EMPANDINCOME_unemployedHomemaker(String getFieldName, String getFieldNameValue){
    ...
    public String getSheetName() throws ClassNotFoundException, NoSuchMethodException{
        return ExcelSheetVerificator.COAPP_EMPLOYMENT_AND_INCOME_UNEMPLOYED_HOMEMAKER.getSheetName();
    }
    ...
    public static List<String> getExpectedFieldNames(String currently){
        List<String> expectedFieldNames = COAPP_EMPANDINCOME_unemployedHomemaker.getExpectedFieldNames();
