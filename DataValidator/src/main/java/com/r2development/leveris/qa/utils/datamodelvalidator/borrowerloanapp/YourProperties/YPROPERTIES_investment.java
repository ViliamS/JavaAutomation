...
public enum YPROPERTIES_investment implements IBWInterface, IBWSheetInterface {

    DO_YOU_HAVE_STAKE_IN_PROPERTY(doEitherOfYouHaveAStakeInAnyProperty, doEitherOfYouHaveAStakeInAnyPropertyYesValue),
    PROPERTY_CATEGORY(yourPropertiesPropertyCategory, yourPropertiesPropertyCategoryInvestmentValue),
    MONTHLY_RENT(yourPropertiesMonthlyRent, null),
    RENT_IS(yourPropertiesRentIs, null),
    ...
    private static final Log log = LogFactory.getLog(YPROPERTIES_investment.class.getName());
    ...
    public String getSheetName() throws ClassNotFoundException, NoSuchMethodException{
        return ExcelSheetVerificator.YOUR_PROPERTIES_INVESTMENT.getSheetName();
    }
    ...
    public static List<String> getDefaultExpectedFieldNames() {
        ...
        expectedFieldNames.add(MONTHLY_RENT.getFieldName());
        expectedFieldNames.add(RENT_IS.getFieldName());
    ...
    public static List<String> getExpectedFieldNames(){ log.info("");
        ...
        defaultExpectedFields.addAll(YPROPERTIES_investment.getDefaultExpectedFieldNames());
    ...
    public static List<String> getExpectedFieldNames(String twoBorrowers, Map<String, String> dataToSearchIn){
        ...
        List<Boolean> addAnotherMortgage = YPROPERTIES_investment.detectAddAnotherMortgage(dataToSearchIn);
