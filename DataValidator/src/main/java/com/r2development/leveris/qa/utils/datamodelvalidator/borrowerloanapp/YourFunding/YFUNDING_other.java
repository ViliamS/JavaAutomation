...
public enum YFUNDING_other implements IBWInterface, IBWSheetInterface {

    WHAT_IS_SOURCE_OF_FUNDS(yourAccountsWhatIsTheSourceOfFunds, yourAccountsWhatIsTheSourceOfFundsOtherValue),
    DESCRIPTION(description, null),
    AMOUNT(amount, null);

    private static final Log log = LogFactory.getLog(YFUNDING_other.class.getName());
    ...
    public String getSheetName() throws ClassNotFoundException, NoSuchMethodException{
        return ExcelSheetVerificator.YOUR_FUNDING_OTHER.getSheetName();
    }
