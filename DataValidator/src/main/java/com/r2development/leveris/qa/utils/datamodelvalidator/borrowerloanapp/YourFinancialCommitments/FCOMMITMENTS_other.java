...
public enum FCOMMITMENTS_other implements IBWInterface, IBWSheetInterface {

    PLEASE_OUTLINE_ANY_SHORT_TERM_DEBT(pleaseOutlineAnyShortTermDebt, pleaseOutlineAnyShortTermDebtYesValue),
    WHAT_IS_TYPE_OF_FINANCIAL_COMMITMENT(financialCommitmentsWhatIsTypeOfFinancialCommitment, financialCommitmentsWhatIsTypeOfFinancialCommitmentOtherValue),
    REPAYMENT_AMOUNT(financialCommitmentsRepaymentAmount, null),
    OTHER_VALUE(financialCommitmentOtherValue, null),
    DESCRIPTION(description, null);

    private static final Log log = LogFactory.getLog(FCOMMITMENTS_other.class.getName());
    ...
    public String getSheetName() throws ClassNotFoundException, NoSuchMethodException{
        return ExcelSheetVerificator.YOUR_FINANCIAL_COMMITMENTS_OTHER.getSheetName();
    }
    ...
    private static List<String> getExpectedFieldNames(){ log.info("");
        ...
        expectedFieldNames.add(OTHER_VALUE.getFieldName());
