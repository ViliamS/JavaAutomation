...
public enum PERSONAL_DETAILS_coapplicant implements IBWInterface, IBWSheetInterface {
    ...
    private static final Log log = LogFactory.getLog(PERSONAL_DETAILS_coapplicant.class.getName());
    ...
    public String getSheetName() throws ClassNotFoundException, NoSuchMethodException{
        return ExcelSheetVerificator.COAPP_PERSONAL_DETAILS_sheetName.getSheetName();
    }
    ...
    private static List<String> getExpectedFieldNames(){ log.info("");
        ...
        //expectedFieldNames.ad(GENDER.getFieldName());
    ...
    public static List<String> getExpectedFieldNames(String gender, String maritalStatus, String nationality, String country, String thisAccommodationIs, String haveYouLivedOnThisAddressFor3Y){
        log.info("PERSONAL_DETAILS_coapplicant executing method getExpectedFieldNames(String gender = '" + gender + "', String maritalStatus = '" + maritalStatus + "', String nationality = '" + nationality + "', String country = '" + country + "', String thisAccommodationIs = '" + thisAccommodationIs + "', String haveYouLivedOnThisAddressFor3Y = '" + haveYouLivedOnThisAddressFor3Y + "')");
        List<String> expectedFieldNames = PERSONAL_DETAILS_coapplicant.getExpectedFieldNames();
