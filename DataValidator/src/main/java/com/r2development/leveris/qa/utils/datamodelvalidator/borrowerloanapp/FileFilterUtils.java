...
public class FileFilterUtils {
     ...
     */
    public static IOFileFilter suffixFileFilter(@SuppressWarnings("SameParameterValue") String suffix) {
     ...
     */
    public static IOFileFilter nameFileFilter(@SuppressWarnings("SameParameterValue") String name) {
