...
public enum COAPP_EMPANDINCOME_selfEmployed implements IBWInterface, IBWSheetInterface{
    ...
    private static final Log log = LogFactory.getLog(COAPP_EMPANDINCOME_selfEmployed.class.getName());

    private String getFieldName;
    private String getFieldNameValue;

    COAPP_EMPANDINCOME_selfEmployed(String getFieldName, String getFieldNameValue){
    ...
    /**
     *
     * @return - Returns String 'Employment and Income - Self Employed'
     * @throws ClassNotFoundException
     * @throws NoSuchMethodException
     */
    public String getSheetName() throws ClassNotFoundException, NoSuchMethodException{
        return ExcelSheetVerificator.COAPP_EMPLOYMENT_AND_INCOME_SELF_EMPLOYED.getSheetName();
    }
    ...
    public static List<String> getExpectedFieldNames(String country, String currently){
        List<String> expectedFieldNames = COAPP_EMPANDINCOME_selfEmployed.getExpectedFieldNames();
