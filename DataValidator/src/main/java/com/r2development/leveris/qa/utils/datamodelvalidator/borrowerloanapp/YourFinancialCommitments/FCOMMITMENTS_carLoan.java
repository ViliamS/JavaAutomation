...
public enum FCOMMITMENTS_carLoan implements IBWInterface, IBWSheetInterface{

    PLEASE_OUTLINE_ANY_SHORT_TERM_DEBT(pleaseOutlineAnyShortTermDebt, pleaseOutlineAnyShortTermDebtYesValue),
    WHAT_IS_TYPE_OF_FINANCIAL_COMMITMENT(financialCommitmentsWhatIsTypeOfFinancialCommitment, financialCommitmentsWhatIsTypeOfFinancialCommitmentCarLoanValue),
    ...
    private static final Log log = LogFactory.getLog(FCOMMITMENTS_carLoan.class.getName());
    ...
    public String getSheetName() throws ClassNotFoundException, NoSuchMethodException{
        return ExcelSheetVerificator.YOUR_FINANCIAL_COMMITMENTS_CAR_LOAN.getSheetName();
    }
