...
public enum YACCOUNTS_savingsAccount implements IBWInterface, IBWSheetInterface {

    WHAT_IS_THE_SOURCE_OF_FUNDS(yourAccountsWhatIsTheSourceOfFunds, YourAccountsWhatIsTheSourceOfFundsSavingsAccountValue),
    ...
    SOURCE_OF_SAVINGS(yourAccountSourceOfSavings, null),
    OVERDRAFT_LIMIT(yourAccountsOverdraftLimit, null);

    private static final Log log = LogFactory.getLog(YACCOUNTS_savingsAccount.class.getName());
    ...
    public String getSheetName() throws ClassNotFoundException, NoSuchMethodException{
        return ExcelSheetVerificator.YOUR_ACCOUNTS_SAVINGS_ACCOUNT.getSheetName();
    }
    ...
    private static List<String> getExpectedFieldNames() {
        ...
        expectedFieldNames.add(SOURCE_OF_SAVINGS.getFieldName());
    ...
    public static List<String> getExpectedFieldNames(String twoBorrowers) {
        List<String>  expectedFieldNames =            YACCOUNTS_subAddAccount.getExpectedFieldNames();
                            expectedFieldNames.addAll(      YACCOUNTS_savingsAccount.getExpectedFieldNames());
