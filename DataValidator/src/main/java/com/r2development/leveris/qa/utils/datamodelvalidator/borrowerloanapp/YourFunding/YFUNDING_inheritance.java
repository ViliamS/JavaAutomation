...
public enum YFUNDING_inheritance implements IBWInterface, IBWSheetInterface {

    WHAT_IS_SOURCE_OF_FUNDS(yourAccountsWhatIsTheSourceOfFunds, yourAccountsWhatIsTheSourceOfFundsInheritanceValue),
    DESCRIPTION(description, null),
    AMOUNT(amount, null);

    private static final Log log = LogFactory.getLog(YFUNDING_inheritance.class.getName());
    ...
    public String getSheetName() throws ClassNotFoundException, NoSuchMethodException{
        return ExcelSheetVerificator.YOUR_FUNDING_INHERITANCE.getSheetName();
    }
