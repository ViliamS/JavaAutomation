...
public enum EMPANDINCOME_other implements IBWInterface, IBWSheetInterface {
    ...
    private static final Log log = LogFactory.getLog(EMPANDINCOME_other.class.getName());
...
//        }
    ...
    public String getSheetName() throws ClassNotFoundException, NoSuchMethodException{
        return ExcelSheetVerificator.BW_EMPLOYMENT_AND_INCOME_OTHER.getSheetName();
    }
