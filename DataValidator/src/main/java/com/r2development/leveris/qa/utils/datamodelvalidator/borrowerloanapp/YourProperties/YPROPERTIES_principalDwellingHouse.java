...
public enum YPROPERTIES_principalDwellingHouse implements IBWInterface, IBWSheetInterface {

    DO_YOU_HAVE_STAKE_IN_PROPERTY(doEitherOfYouHaveAStakeInAnyProperty, doEitherOfYouHaveAStakeInAnyPropertyYesValue),
    PROPERTY_CATEGORY(yourPropertiesPropertyCategory, yourPropertiesPropertyCategoryPrincipalDwellingHouseValue),
    ...
    private static final Log log = LogFactory.getLog(YPROPERTIES_principalDwellingHouse.class.getName());
    ...
    public String getSheetName() throws ClassNotFoundException, NoSuchMethodException{
        return ExcelSheetVerificator.YOUR_PROPERTIES_PRINCIPAL_DWELLING_HOUSE.getSheetName();
    }
     ...
     */
    private static List<String> getDefaultExpectedFieldNames() {
    ...
    public static List<String> getExpectedFieldNames(){ log.info("");
        ...
        defaultExpectedFields.addAll(YPROPERTIES_principalDwellingHouse.getDefaultExpectedFieldNames());
    ...
    public static List<String> getExpectedFieldNames(String twoBorrowers, Map<String, String> dataToSearchIn){
        List<String> expectedFields = YPROPERTIES_principalDwellingHouse.getExpectedFieldNames();
        ...
        List<Boolean> addAnotherMortgage = YPROPERTIES_principalDwellingHouse.detectAddAnotherMortgage(dataToSearchIn);
        ...
        switch (isThisPropertyMortgagedValue) {
            ...
            case isThisPropertyMortgagedNoNeverHadAMortgage :
                expectedFields.add(IS_THIS_PROPERTY_MORTGAGED.getFieldName());
                break;
        }
    ...
    public static List<Boolean> detectAddAnotherMortgage(Map<String, String> dataToSearch) {
        ...
        //This case is creating first entry True for "Is this propertyMortgaged" without index
        ...
        if (dataToSearch.get(YPROPERTIES_subIsThisPropertyMortgagedYes.ADD_ANOTHER_MORTGAGE_ACCOUNT.getFieldNameWithIndex(2)) != null) {
            //Is there entry with index ".2" containing value "Yes"
            if (dataToSearch.get(YPROPERTIES_subIsThisPropertyMortgagedYes.ADD_ANOTHER_MORTGAGE_ACCOUNT.getFieldNameWithIndex(2)).equalsIgnoreCase(addAnotherMortgageAccountYesValue)) {
