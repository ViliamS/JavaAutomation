...
public interface IAutomaticRegistrationSection {
    ...
    String OPOQUO_APPLICANTS_ID_INPUT_XPATH = "//input[@wicketpath='main_c_form_form_root_c_w_pnlMain_c_w_txtId_tb']";
    String OPOQUO_APPLICANT_READ_ONLY_INPUT_XPATH = "//input[@wicketpath='main_c_form_form_root_c_w_pnlMain_c_w_txtApp_tb']";
    String OPOQUO_PASSWORD_READ_ONLY_INPUT_XPATH = "//input[@wicketpath='main_c_form_form_root_c_w_pnlMain_c_w_txtPass_tb']";
