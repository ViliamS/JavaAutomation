...
public interface IYourAccountsPage {
    ...
    IYourAccountsPage iAgreeCheckbox(String action);

    IYourAccountsAccountScrapingWindow clickStartScraping() throws InterruptedException;
    ...
    IYourAccountsPage typeAccountName(String accountName);
