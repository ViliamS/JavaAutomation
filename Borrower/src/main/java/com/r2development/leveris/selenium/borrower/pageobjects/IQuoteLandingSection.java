...
public interface IQuoteLandingSection {
    ...
    String
            ...
            UNSECURED_LOAN_SMALL_CONTINUE =         "/div[contains(@wicketpath,'UnsecuredLoanSmall')]//div[contains(@wicketpath,'btnContinue')]",
            ...
            DIV_CONTAINS_BTN_CONTINUE =             "//div[contains(@wicketpath,'btnContinue')]",
            UP_UP_PRECEDING_SIBLING_FIRST_DIV =     "/../../preceding-sibling::div[1]",
            CONTAINS_WICKETPATH_MORTGAGE =          "[contains(@wicketpath,'pnlMortgage')]",
            CONTAINS_WICKETPATH_LBLAMOUNT =         "[contains(@wicketpath,'lblAmount')]",
            CONTAINS_WICKETPATH_DEBT_CONS =         "[contains(@wicketpath,'pnlDebitConsolidation')]",
            CONTAINS_WICKETPATH_UNSECURED_LOAN =    "[contains(@wicketpath,'UnsecuredLoan')]",

            A_CONTINUE = "/a[contains(@wicketpath,'btnContinue1_submit')]]",
            A_CONTINUE2 = "/a[contains(@wicketpath,'btnContinue_submit')]",
            ...
            PAYDAY_LOAN_CONTINUE_BUTTON_XPATH =     PAYDAY_LOAN_PANEL_XPATH         + DIV_CONTAINS_BTN_CONTINUE + A_CONTINUE2,
