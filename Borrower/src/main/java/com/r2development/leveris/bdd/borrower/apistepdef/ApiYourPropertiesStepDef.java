...
@Singleton
public class ApiYourPropertiesStepDef extends ApiAbakusBorrowerStepDef {
...
//                                        "    }" +
    ...
    public void user_has_properties_in_the_past(String hasPropertyInThePast) throws IOException {
        if (hasPropertyInThePast == null) {
            ...
            requestHttpPost(
                    httpClient,
                    System.getProperty("borrower") + "/form.2?wicket:interface=:1:main:c:form:form:root:c:w:pnlMain:c:w:pnlPropertyPast:c:w:btnPropertyPastNoIDont:submit::IBehaviorListener:0:",
                    new LinkedHashMap<String, String>() {
                        {
                            put("Accept", "text/xml");
                            put("Content-Type", "application/x-www-form-urlencoded");
...
//                            put("root:c:w:pnlMain:c:w:pnlPropertyPast:c:w:rgrPastProperty:rg:radNoPropery", "1");
            ...
            requestHttpPost(
                    httpClient,
                    System.getProperty("borrower") + "/form.2?wicket:interface=:1:main:c:form:form:root:c:w:pnlNoProperties:c:w:btnNextSection:submit::IBehaviorListener:0:",
                    new LinkedHashMap<String, String>() {
                        {
                            put("Accept", "text/xml");
                            put("Content-Type", "application/x-www-form-urlencoded");
