...
#    PERSONAL DETAILS
    ...
    And borrower user types his firstname : Tony
...
#    EMPLOYMENT & INCOME
    ...
    And borrower user clicks the employment & income category : Paye
...
#    And borrower user checks the Paye currently
    ...
    Then borrower user clicks the employment & income category : SelfEmployed
    ...
    When borrower user clicks "ADD EMPLOYMENT"
#    Then borrower user sees his name in the Employment & Income title
    And borrower user clicks the employment & income category : CivilServant
    ...
    When borrower user clicks "ADD EMPLOYMENT"
    Then borrower user clicks the employment & income category : Unemployed/Homemaker
    ...
    When borrower user clicks "ADD EMPLOYMENT"
    Then borrower user clicks the employment & income category : Other
    ...
    And coapplicant user clicks the employment & income category : Paye
    # problem of xpath or select method
...
#    And coapplicant user checks the Paye currently
    ...
    Then coapplicant user clicks the employment & income category : SelfEmployed
...
#    Then coapplicant user sees his name in the Employment & Income title
    ...
    When coapplicant user clicks "ADD EMPLOYMENT"
    Then coapplicant user clicks the employment & income category : Unemployed/Homemaker
    ...
    When coapplicant user clicks "ADD EMPLOYMENT"
    Then coapplicant user clicks the employment & income category : Other
...
#    When user clicks "Account"
    ...
    And user types his Current IBAN: IE92BOFI90001710027952
    ...
    And user types his Savings IBAN: CZ4855000000001021018730
